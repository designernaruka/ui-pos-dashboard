;(function ($, window, document, undefined) {
  ...
  BootstrapDualListbox.prototype = {
    init: function () {
      ...
      this.container = $('' +
        '<div class="bootstrap-duallistbox-container d-flex">' +
        ' <div class="box1 extisting-policy-search">' +
        '   <label></label>' +
        // '   <span class="info-container">' +
        // '     <span class="info"></span>' +
        // '     <button type="button" class="btn clear1 pull-right"></button>' +
        // '   </span>' +
        '   <div class="form-group rounded border bottom mb-0">' +
        ...
        '   <div type="button" class="ei ei-exchange-1-1">' +
        '   </div>' +
        ' </div>' +
        ' <div class="box2 extisting-policy-search">' +
        '   <label></label>' +
        // '   <span class="info-container">' +
        // '     <span class="info"></span>' +
